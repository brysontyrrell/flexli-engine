...
# TODO: `order` should not be constrained to 100
...
class WorkflowsV1CreateEventSource(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class WorkflowV1CreateActionOnErrorBackoff(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class WorkflowV1CreateActionOnError(BaseModel):
    model_config = ConfigDict(extra="forbid")

    max_retries: conint(gt=0, lt=11)
    retry_on: Optional[list[str]] = None
    on_fail: Optional[OnFailOptions] = None
    backoff: Optional[WorkflowV1CreateActionOnErrorBackoff] = None


class WorkflowsV1CreateAction(BaseModel):
    model_config = ConfigDict(extra="forbid")
    ...
    on_error: Optional[WorkflowV1CreateActionOnError] = None
...
WorkflowsV1CreateCoreV1Actions = Annotated[
    Union[
        CoreV1Transform,
        CoreV1Wait,
        CoreV1RunWorkflow,
...
class WorkflowV1CreateWorkflowOnErrorBackoff(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class WorkflowV1CreateWorkflowOnError(BaseModel):
    model_config = ConfigDict(extra="forbid")

    max_retries: conint(gt=0, lt=11)
    retry_on: Optional[list[str]] = None
    backoff: Optional[WorkflowV1CreateWorkflowOnErrorBackoff] = None
...
class WorkflowsV1Create(BaseModel):
    ...
    enabled: bool = True
    timeout: Optional[conint(gt=0, lt=901)] = None  # 15 minute max runtime?
    on_error: Optional[WorkflowV1CreateWorkflowOnError] = None
    source: Optional[Union[CoreV1Sources, WorkflowsV1CreateEventSource]] = None
    actions: conlist(
        Union[WorkflowsV1CreateCoreV1Actions, WorkflowsV1CreateAction],
        min_length=1,
        max_length=100,
    )
